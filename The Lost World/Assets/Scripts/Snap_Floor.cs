...
public class Snap_Floor : MonoBehaviour
{
                                         ///scriptu asta se atrinuie la floor pt snap si e numai cand plasezi cand o lasi dispare scriptu ///
    ...
    {
        if (collision.collider.tag == "Snap_Floor_Collider")
        {
